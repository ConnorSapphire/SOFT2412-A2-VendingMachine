...
public class FileManagerTest {
    ...
    //     Product chip = creator.create("Smith", "SMH", 5.0, 10, 0);
    ...
    //     Product drink = creator.create("Sprite", "SPT", 5.0, 10, 0);
    ...
    //     ProductCreator creator = new ChipCreator();
    //     Product chocolate = creator.create("Mars", "MAS", 5.0, 10, 0);
    ...
    //     ProductCreator creator = new ChipCreator();
    //     Product candy = creator.create("Skittles", "SKI", 5.0, 10, 0);
